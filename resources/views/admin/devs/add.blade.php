...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">إضافة مطوّر جديد</li>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3>إضافة مطوّر جديد</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.devs.store') }}" method="POST" enctype="multipart/form-data" name="devAddForm">
                        <fieldset>
                            @csrf
